...
int main()
{
    ...
    unsigned long int key_prototype = 633100000;
    ...
    int key_comp[48] = { 14, 17, 11, 24, 1, 5,
      ...
      // Key Generation
      while(cipher.compare("45F1CC01273F3139"))
      {
          key = int_to_hex(key_prototype);
          key_prototype = (unsigned long int)key_prototype+1;
          if(key_prototype%100000 == 0)
          {
            cout << "Still going <" << key_prototype << ">" << endl;
          }
          key = hex2bin(key);
      ...
      cout << "Key is: " << int_to_hex(key_prototype-1) << endl;
      end = clock();
      cout << "Completion in <" << (double)((double)(end - start)/CLOCKS_PER_SEC) << "> secondes" << endl;
